...
internal static class ValidationPaths
{
    ...
    private static string ToOperatorName(LogicalOp op) => op switch
    {
        LogicalOp.All => "all",
        LogicalOp.Any => "any",
        LogicalOp.Not => "not",
    ...
    private static string ToOperatorName(CompareOp op) => op switch
    {
        CompareOp.Eq => "eq",
        CompareOp.Neq => "neq",
        CompareOp.Gt => "gt",
    ...
    private static string ToOperatorName(MembershipOp op) => op switch
    {
        MembershipOp.In => "in",
    ...
    private static string ToOperatorName(QuantifierOp op) => op switch
    {
    ...
    private static string ToOperatorName(AggregateOp op) => op switch
    {
        AggregateOp.Sum => "sum",
    ...
    private static string ToOperatorName(ArithmeticOp op) => op switch
    {
